...
from desi.processor.cli import parse_args as processor_parse_args
from desi.processor.cli import run_with_args as processor_run
from desi.query.query import DesiRAGQueryEngine
from desi.scraper.cli import parse_args as scraper_parse_args
from desi.scraper.cli import run_with_args as scraper_run
    ...
    try:
        ...
        scraper_args = scraper_parse_args(
            [
                "readthedocs",
                "--url",
                "https://openbis.readthedocs.io/en/20.10.0-11/",
                "--output",
                str(openbis_dir),
                "--max-pages",
                str(max_pages),
...
def test_querying(temp_dir: Path):
    ...
    try:
        ...
        query_engine = DesiRAGQueryEngine(
            db_path=str(db_dir), collection_name="desi_docs"
        )
        ...
        # Test retrieval
        test_queries = ["openBIS", "experiment", "data management", "documentation"]
...
def main():
    ...
    parser.add_argument(
        "--max-pages", type=int, default=3, help="Maximum pages to scrape for testing"
    )
